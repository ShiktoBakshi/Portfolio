...
import email from "../Component/Animation/Email.json";
...
const Contact = () => {
    const handleSubmit = (e) => {
        ...
        toast.success("🚀 Message Sent Successfully!", {
            ...
            theme: "colored",
            style: {
                background: "linear-gradient(90deg, #06b6d4, #22d3ee)", // cyan gradient
                color: "#fff",
                fontWeight: "bold",
    ...
    return (
        <section id="contact" className="relative py-20  text-white overflow-hidden">
            ...
            <div className="container mx-auto flex flex-col lg:flex-row justify-center items-center gap-16 relative z-10">
                ...
                <div className="  flex flex-col justify-center items-center text-center space-y-8">
                    ...
                    <div className="flex flex-col items-center text-center mt-6">
                        ...
                        <div className="flex flex-wrap justify-center gap-6 text-gray-300 text-sm md:text-base mb-6">
                            ...
                            <p className="flex items-center gap-2">
                                <FaWhatsapp className="text-green-400" /> +8801317124906
                            </p>
                            <p className="flex items-center gap-2">
                                <MdEmail className="text-sky-400" /> ahibm594@gmail.com
                            </p>
                        </div>

                        {/* Find Me Online */}
                        <div className="mt-4">
                            <h2 className="text-lg font-semibold mb-3  bg-linear-to-r from-sky-400 to-cyan-300 bg-clip-text text-transparent">
                                Find Me Online
                            </h2>
                            <div className="flex justify-center gap-8 text-2xl">
                                <a href="https://github.com/ShiktoBakshi" className="hover:text-sky-400 transition-all duration-300">
                                    <FaGithub />
                                </a>
                                
                                <a href="https://www.facebook.com/ahosan.B.M.AhiTannjil" className="hover:text-sky-400 transition-all duration-300">
                                    <FaLinkedinIn />
                                </a>
                                 <a href="https://wa.me/qr/XWRPT42ED3O5K1" className="hover:text-sky-400 transition-all duration-300">
                                    <FaWhatsapp />
                                </a>
                                <a href="https://www.linkedin.com/in/b-m-ahi-tanjil-ahosan-052582307?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="hover:text-sky-400 transition-all duration-300">
                                    <CiFacebook />
                                </a>
                                <a href="https://www.instagram.com/shiktobakshi?igsh=ZzY3OXhqaXptYW5w" className="hover:text-sky-400 transition-all duration-300">
                                   <CiInstagram/>
                                </a>
                ...
                {/* Right: Contact Form */}
                <form onSubmit={handleSubmit} className="bg-gray-900/50 backdrop-blur-xl border border-cyan-500/40 rounded-2xl p-8 w-full max-w-lg shadow-[0_0_25px_rgba(56,189,248,0.15)] hover:shadow-[0_0_40px_rgba(56,189,248,0.4)] transition-all duration-500">
